function [all_themes, all_colors] = GetColors()%https://zhuanlan.zhihu.com/p/444970597
% 颜值即正义1
...
c_string{61} = {'#D9ED92', '#B5E48C', '#99D98C', '#76C893', '#52B69A',...
    '#34A0A4', '#168AAD', '#1A759F', '#1E6091', '#184E77'};

c_string{62} = {'#FFEDD8', '#F3D5B5', '#E7BC91', '#D4A276', '#BC8A5F',...
    '#A47148', '#8B5E34', '#6F4518', '#603808', '#583101'};
% 科研配色
c_string{63} = {'#403990', '#80A6E2', '#FBDD85', '#F46F43', '#CF3D3E'};
% 十六进制转成RGB颜色
% 获取所有的颜色
